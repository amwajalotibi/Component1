...
// --------------------
function better_input(v,e)//comment from the previous Assignment
{
// set vertex and edge count fields
this.nv = v.length; //vertex count 
this.ne = e.length; // edge count
...
// --------------------
function add_edge(u_i,v_i)//comment from the previous Assignment 
{
...
function dfs(v_i)
{
 ...
 l_pop = this.dfs_pop.length;
 this.dfs_pop[l_pop] = v_i;
